...
{     
      uint32 Temp;
      Temp = (((((GPIO_MemMapPtr)0x400FF000u))->PDIR) & (1 << 25) );
      if(Temp)
        return 1;
      else 
        return 0;
...
void SCLIn(void)
{
    ((((GPIO_MemMapPtr)0x400FF000u))->PDDR) &= ~(1 << 26);
}
...
void SCLClear(void)
{
    ((((GPIO_MemMapPtr)0x400FF000u))->PDOR) &= ~(1 << 26);
}
...
void SDAIn(void)
{
    ((((GPIO_MemMapPtr)0x400FF000u))->PDDR) &= ~(1 << 25);
}
...
void SDAClear(void)
{
    ((((GPIO_MemMapPtr)0x400FF000u))->PDOR) &= ~(1 << 25);
}
...
void SCCBPortInit(void)
{
    ...
    ((((PORT_MemMapPtr)0x40049000u))->PCR[26]) |= (
                                    (((uint32_t)(((uint32_t)(0x01))<<8))&0x700u) 
                                  | 0x2u 
                                  | 0x20u
                                  );
    ((((PORT_MemMapPtr)0x40049000u))->PCR[25]) |= (
                                    (((uint32_t)(((uint32_t)(0x01))<<8))&0x700u) 
                                  | 0x2u 
                                  | 0x20u
                                  );

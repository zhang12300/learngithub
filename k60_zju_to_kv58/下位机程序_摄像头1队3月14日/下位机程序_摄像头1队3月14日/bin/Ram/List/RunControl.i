...
uint8 DuZhuanFlag = 0;              
uint8 TimeOutFlag = 0;              
uint16 StopLineSpeed = 0;            
uint8 StopLineControlFlag = 0;             
uint8 StopLineSpeedControlPauseFlag = 0;          


uint16 SpeedXiaoZhiDao = 280;       
uint16 SpeedTargetValGryoUp = 200;  
uint16 SpeedBrick = 200;            

uint16 StopFlagMaxCount = 0;      
uint16 StopFlagMaxCountNum = 5;      

uint16 SpeedStrategyChosen = 0;     
uint16 MotorTakeOffQuadCountLimit = 0; 
uint16 SpeedTargetValStraight = 350;      
uint16 SpeedTargetValWaitStop = 20;     

uint8 StopRealFlag = 0;     

int32 ServoTemp = 0;
int32 DeltaVelocity = 0;   

int16 ErrorCountNow0 = 0;
int16 ErrorCountNow1 = 0;
int32 temp_speed_D;
int32 temp_speed_P;
uint8 MotorTakeOffFlag = 0;   
uint8 SpeedTargetLevel;
uint8 StopFlag=0;       
...
uint16 SpeedTargetMat[9][11]=
{
  ...
  10,10,10,10,10,10,10,10,10,10,10,
   ...
   200, 200, 210, 220, 230, 240, 230, 220, 210, 200, 200,    
   210, 210, 220, 230, 240, 260, 240, 230, 220, 210, 210,    
   210, 220, 230, 240, 250, 280, 250, 240, 230, 220, 210,    
   210, 225, 235, 250, 260, 280, 260, 250, 235, 225, 210,    
   210, 210, 240, 250, 270, 300, 270, 250, 240, 210, 210,    
   220, 230, 240, 260, 280, 300, 280, 260, 240, 230, 220,    
   200, 210, 220, 240, 280, 330, 280, 240, 220, 210, 200,    
   210, 220, 230, 250, 280, 330, 280, 250, 230, 220, 210,    
};
...
uint8 DoneFlag = 0;
uint8 QuadSpeedLevel = 0;    
uint8 SlopeCLevel = 0;        


uint16 ServoPIDP = 0;                   
uint16 ServoPIDD = 0;                   
uint32 ServoPIDInputVal = 1730;            
uint32 ServoPIDInputValOld = 1730;         
int32 ServoPIDInputValP = 0;            
int32 ServoPIDInputValD = 0;            





uint32 SpeedTargetVal = 0;               
uint32 SpeedLastTargetVal = 0;           
uint16 SpeedTargetLeftVal = 0;           
uint16 SpeedTargetRightVal = 0;          
uint16 SpeedLastTargetLeftVal = 0;       
uint16 SpeedLastTargetRightVal = 0;      

uint16 SpeedPIDPVal = 25;                  
uint16 SpeedPIDDVal = 65;                   
uint16 SpeedPIDIVal = 0;                 
int32 speed_kp,speed_kd;

int32 SpeedLeftVal = 0;                
int32 SpeedRightVal = 0;               
int32 SpeedLeftValP = 0;               
int32 SpeedLeftValD = 0;               
int32 SpeedRightValP = 0;              
int32 SpeedRightValD = 0;              

int16 temptempSpeedLeftVal;

uint8 SpeedDiffGetSwitch =0;          


uint8 StrategyLoadSpeedIndex = 1;      
...
{ 
  ...
  ServoPIDInputVal = 1730 + ServoPIDInputValP + ServoPIDInputValD;
  ...
  if(ShiZhiFlag==1)
  {
      if(ServoPIDInputVal >= (2110-1730)/5+1730)
      {
        ServoPIDInputVal = (2110-1730)/5+1730;
      }
      
      else if(ServoPIDInputVal <= 1730-(1730-1350)/5)
      {
        ServoPIDInputVal = 1730-(1730-1350)/5;
      }
      DeviFuse = 0;
  }
   
  
  if(ServoPIDInputVal >= 2110)
  {
    ServoPIDInputVal = 2110;
  }
  
  else if(ServoPIDInputVal <= 1350)
  {
    ServoPIDInputVal = 1350;
  }
  ...
  ((((FTM_MemMapPtr)0x40039000u))->CONTROLS[0]. CnV) = (uint16)(2*1730-ServoPIDInputVal);
  return 1;
}
...
uint16 SpeedDiffGet(uint16 tempSpeedTarget, uint8 num)
{
  ...
  ServoTemp = AbsInt(1730 - ServoPIDInputVal);
 
  DeltaVelocity = ((1000 * ServoTemp / 125)  + (71 * ServoTemp * ServoTemp * ServoTemp / 1000000))*13/10;
  
 
  
  if(ServoPIDInputVal > 1730)
  {
...
uint8 MotorPID(void)
{
  ...
  if(MotorTakeOffFlag == 1)
  {
    ...
    if(SpeedRightVal >= 500)
    {
      SpeedRightVal = 500;
    }
    else if(SpeedRightVal <= (-300))
    {
      SpeedRightVal = (-300);
    }
    else
    ...
    if(SpeedNowLeft > MotorTakeOffQuadCountLimit)
    {
      MotorTakeOffFlag = 0;
    }
    else
  ...
  else
  {
    ...
    else
    {
      ...
      if(StopFlag == 1)   
      {
         ...
         if(SpeedNowLeft < 20 || SpeedNowRight < 20 || StopFlagMaxCount > StopFlagMaxCountNum * 6) 
         {
           StopRealFlag = 1;
         }
         else
      ...
      else
      {
        ...
        if(SpeedLeftVal>0)
        {
         ...
         ((((FTM_MemMapPtr)0x40038000u))->CONTROLS[5]. CnV) = 300;
         ((((FTM_MemMapPtr)0x40038000u))->CONTROLS[4]. CnV) = 100;
    
          if(StopLineSpeedControlPauseFlag == 1)
          {
            ((((FTM_MemMapPtr)0x40038000u))->CONTROLS[4]. CnV) = 1000;
            ((((FTM_MemMapPtr)0x40038000u))->CONTROLS[5]. CnV) = 1000;
          }
        }
        else
        {
        ...
        if(SpeedRightVal>0)
        {
          ...
          ((((FTM_MemMapPtr)0x40038000u))->CONTROLS[6]. CnV) = 300;        
          ((((FTM_MemMapPtr)0x40038000u))->CONTROLS[7]. CnV) = 100;
          if(StopLineSpeedControlPauseFlag == 1)
          {
            ((((FTM_MemMapPtr)0x40038000u))->CONTROLS[6]. CnV) = 1000;
            ((((FTM_MemMapPtr)0x40038000u))->CONTROLS[7]. CnV) = 1000;
          }

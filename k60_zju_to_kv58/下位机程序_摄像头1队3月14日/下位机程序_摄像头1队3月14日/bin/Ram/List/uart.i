...
void uart_init (UART_MemMapPtr uartch, uint32 sysclk, uint32 baud)
{
	...
	if (uartch == ((UART_MemMapPtr)0x4006A000u))
	{
		
		((((PORT_MemMapPtr)0x4004A000u))->PCR[17]) = (((uint32_t)(((uint32_t)(0x3))<<8))&0x700u);
		
		((((PORT_MemMapPtr)0x4004A000u))->PCR[16]) = (((uint32_t)(((uint32_t)(0x3))<<8))&0x700u); 
	}else if (uartch == ((UART_MemMapPtr)0x4006B000u))
	{
		
		((((PORT_MemMapPtr)0x4004B000u))->PCR[4]) = (((uint32_t)(((uint32_t)(0x3))<<8))&0x700u); 
		
		
		((((PORT_MemMapPtr)0x4004B000u))->PCR[3]) = (((uint32_t)(((uint32_t)(0x3))<<8))&0x700u); 
	}else if (uartch == ((UART_MemMapPtr)0x4006C000u))
	{
		
		((((PORT_MemMapPtr)0x4004C000u))->PCR[3]) = (((uint32_t)(((uint32_t)(0x3))<<8))&0x700u); 
		
		((((PORT_MemMapPtr)0x4004C000u))->PCR[2]) = (((uint32_t)(((uint32_t)(0x3))<<8))&0x700u); 
	}else if (uartch == ((UART_MemMapPtr)0x4006D000u))
	{
		
		((((PORT_MemMapPtr)0x4004B000u))->PCR[17]) = (((uint32_t)(((uint32_t)(0x3))<<8))&0x700u); 
		
		((((PORT_MemMapPtr)0x4004B000u))->PCR[16]) = (((uint32_t)(((uint32_t)(0x3))<<8))&0x700u); 
	}else if (uartch == ((UART_MemMapPtr)0x400EA000u))
	{
		
		((((PORT_MemMapPtr)0x4004D000u))->PCR[24]) = (((uint32_t)(((uint32_t)(0x3))<<8))&0x700u); 
		
		((((PORT_MemMapPtr)0x4004D000u))->PCR[25]) = (((uint32_t)(((uint32_t)(0x3))<<8))&0x700u); 
	}else if (uartch == ((UART_MemMapPtr)0x400EB000u))
	{
		
		((((PORT_MemMapPtr)0x4004D000u))->PCR[8]) = (((uint32_t)(((uint32_t)(0x3))<<8))&0x700u); 
		
		((((PORT_MemMapPtr)0x4004D000u))->PCR[9]) = (((uint32_t)(((uint32_t)(0x3))<<8))&0x700u); 
	}
	 
	
	if(uartch == ((UART_MemMapPtr)0x4006A000u))
		((((SIM_MemMapPtr)0x40047000u))->SCGC4) |= 0x400u;
	else
		if (uartch == ((UART_MemMapPtr)0x4006B000u))
			((((SIM_MemMapPtr)0x40047000u))->SCGC4) |= 0x800u;
		else
			if (uartch == ((UART_MemMapPtr)0x4006C000u))
				((((SIM_MemMapPtr)0x40047000u))->SCGC4) |= 0x1000u;
			else
				if(uartch == ((UART_MemMapPtr)0x4006D000u))
					((((SIM_MemMapPtr)0x40047000u))->SCGC4) |= 0x2000u;
				else
					if(uartch == ((UART_MemMapPtr)0x400EA000u))
						((((SIM_MemMapPtr)0x40047000u))->SCGC1) |= 0x400u;
					else
						((((SIM_MemMapPtr)0x40047000u))->SCGC1) |= 0x800u;
	...
	if ((uartch == ((UART_MemMapPtr)0x4006A000u)) | (uartch == ((UART_MemMapPtr)0x4006B000u)))
		sysclk+=sysclk;
	
	sbr = (uint16)((sysclk*1000)/(baud * 16));
	temp = ((uartch)->BDH) & ~((((uint8_t)(((uint8_t)(0x1F))<<0))&0x1Fu));
	((uartch)->BDH) = temp |  (((uint8_t)(((uint8_t)(((sbr & 0x1F00) >> 8)))<<0))&0x1Fu);
	((uartch)->BDL) = (uint8)(sbr & 0xFFu);
	brfa = (((sysclk*32000)/(baud * 16)) - (sbr * 32));
	temp = ((uartch)->C4) & ~((((uint8_t)(((uint8_t)(0x1F))<<0))&0x1Fu));
	((uartch)->C4) = temp |  (((uint8_t)(((uint8_t)(brfa))<<0))&0x1Fu);    

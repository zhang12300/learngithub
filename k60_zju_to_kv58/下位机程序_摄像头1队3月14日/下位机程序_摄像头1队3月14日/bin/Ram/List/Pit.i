...
void pit_init(uint8 pitno,uint32 timeout)
{
  ((((SIM_MemMapPtr)0x40047000u))->SCGC6) |= 0x800000u;              
  ((((PIT_MemMapPtr)0x40037000u))->MCR) &= ~(0x2u);              
  ((((PIT_MemMapPtr)0x40037000u))->MCR) |= 0x1u;                  
  ((((PIT_MemMapPtr)0x40037000u))->CHANNEL[pitno]. LDVAL) = timeout;                   
  ((((PIT_MemMapPtr)0x40037000u))->CHANNEL[pitno]. TCTRL) |= 0x1u;       
  ((((PIT_MemMapPtr)0x40037000u))->CHANNEL[pitno]. TCTRL) &= ~(0x2u);    
}

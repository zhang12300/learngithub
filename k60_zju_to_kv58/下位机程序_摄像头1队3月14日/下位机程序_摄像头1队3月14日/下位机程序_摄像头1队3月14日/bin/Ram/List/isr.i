...
uint8 QuadChangeFlag = 0;       
uint32 QuadLeftCount = 0;       
uint32 QuadRightCount = 0;      
uint8 PIT0Count = 0;            

uint16 DiffCountL = 0;        
uint16 DiffCountR = 0;        

uint8 PIT2_Isr_Change = 0;    
uint8 LightHouseWaitStartTooLongFlag = 0;   
volatile uint8 QuadDoneFlag = 0;         
...
void uart0_isr(void)
{
    ...
    if(cnt == 0){uart_re1 (((UART_MemMapPtr)0x4006A000u),&ch0);cnt++;}
    if(cnt == 1){uart_re1 (((UART_MemMapPtr)0x4006A000u),&ch1);cnt++;}
    if(cnt == 2){uart_re1 (((UART_MemMapPtr)0x4006A000u),&ch2);cnt++;}
    if(cnt == 3){uart_re1 (((UART_MemMapPtr)0x4006A000u),&ch3);cnt++;}
    if(cnt == 4){uart_re1 (((UART_MemMapPtr)0x4006A000u),&ch4);cnt++;}
    if(cnt == 5){uart_re1 (((UART_MemMapPtr)0x4006A000u),&ch5);cnt++;}
    if(cnt == 6)
    {
        uart_re1 (((UART_MemMapPtr)0x4006A000u),&ch6);cnt=0;
        if(ch0==0xFF && ch1==0x55 && ch2==0xAA && ch3==0x77 && ch4==0x01 && ch5==0x06 && ch6==0x7C)
        {
            uart_sendN(((UART_MemMapPtr)0x4006A000u), (uint8 *)"\nCar Start!", 11);
            StopRealFlag = 0;
            light_control(((GPIO_MemMapPtr)0x400FF100u), 26, 0);
        }
...
void PIT0_Isr(void)
{       
    if((((((PIT_MemMapPtr)0x40037000u))->CHANNEL[0]. TFLG)&0x1u)!=0)
    {
      ((((PIT_MemMapPtr)0x40037000u))->CHANNEL[0]. TFLG) |= 0x1u;  
    }
...
void PIT1_Isr(void)
{       
    if((((((PIT_MemMapPtr)0x40037000u))->CHANNEL[1]. TFLG)&0x1u)!=0)
    {
      ((((PIT_MemMapPtr)0x40037000u))->CHANNEL[1]. TFLG) |= 0x1u;  
    }
...
void PIT2_Isr(void)
{
  if((((((PIT_MemMapPtr)0x40037000u))->CHANNEL[2]. TFLG)&0x1u)!=0)
  {
    ((((PIT_MemMapPtr)0x40037000u))->CHANNEL[2]. TFLG) |= 0x1u;  
  }
...
void DMA0_Isr(void)
{
    ...
    ((((DMA_MemMapPtr)0x40008000u))->INT) |= (1 << DMACHno);    
    LineCount++;              
    
    if(LineCount >= 60)   
    {
        ImgStatus = ImgGetFinish;    
...
void PORTA_Isr(void)  
{
    ((((PORT_MemMapPtr)0x40049000u))->ISFR) = ~0;
    uart_sendN(((UART_MemMapPtr)0x4006A000u), (uint8 *)"\nError In PORTA_Isr()!", 22); 
}
...
void PORTB_Isr(void)  
{
    ((((PORT_MemMapPtr)0x4004A000u))->ISFR) = ~0;
    uart_sendN(((UART_MemMapPtr)0x4006A000u), (uint8 *)"\nError In PORTB_Isr()!", 22);  
}
...
void PORTC_Isr(void)  
{
    uint32 FlagTmp = ((((PORT_MemMapPtr)0x4004B000u))->ISFR);  
    ((((PORT_MemMapPtr)0x4004B000u))->ISFR) =  ~0;             
...
void PORTD_Isr(void)  
{
    uint32 FlagTmp = ((((PORT_MemMapPtr)0x4004C000u))->ISFR);  
    ((((PORT_MemMapPtr)0x4004C000u))->ISFR) =  ~0;             
...
void PORTE_Isr(void)  
{
    ((((PORT_MemMapPtr)0x4004D000u))->ISFR) = ~0;
    uart_sendN(((UART_MemMapPtr)0x4006A000u), (uint8 *)"\nError In PORTE_Isr()!", 22);   
}

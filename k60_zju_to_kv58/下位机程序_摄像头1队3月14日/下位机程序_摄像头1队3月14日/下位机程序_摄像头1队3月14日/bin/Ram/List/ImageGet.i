...
uint8 const LineRealCountVal120_60_01[60] = 
{
60,62,64,66,68,
70,72,74,76,78,
80,82,84,86,88,
...
uint8 const LineRealCountVal120_60_02[60] = 
{
...
{    
    ...
    if(ImgStatus == ImgGetStart)  
    {
      ...
      if(ImgPresent == 1)    
      {
          ((DMA_MemMapPtr)0x40008000u)->TCD[0].DADDR = (uint32)ImgStore1[0];     
      }
      else if(ImgPresent == 2)  
      {
          ((DMA_MemMapPtr)0x40008000u)->TCD[0].DADDR = (uint32)ImgStore2[0];     
      }
      else 
      {
      ...
      ((((DMA_MemMapPtr)0x40008000u))->ERQ) &= ~(1 << 0);      
    }
    else
    {
...
void LineIsr(void)
{
    ...
    if(LineRealCount == LineRealCountVal120_60_02[LineCount])  
    {

...
uint8 uSendBuf[17*2]={0};
uint8 FreeCarsDataNum=17*2;
...
void VirtualOutPut_Data(void)
{
  ...
  for(i=0;i<10;i++)
  uart_send1(((UART_MemMapPtr)0x4006A000u),databuf[i]);
}
...
void Virtual2Send(void)
{
  ...
  uart_send1(((UART_MemMapPtr)0x4006A000u),251);
  uart_send1(((UART_MemMapPtr)0x4006A000u),109);
  uart_send1(((UART_MemMapPtr)0x4006A000u),37);
  sum+=(251);      
  sum+=(109);
  sum+=(37);
  for(i=0;i<FreeCarsDataNum;i++)
  {
    uart_send1(((UART_MemMapPtr)0x4006A000u),uSendBuf[i]);
    sum+=uSendBuf[i];         
  }
  uart_send1(((UART_MemMapPtr)0x4006A000u),sum);
}

...
void gpio_init (GPIO_MemMapPtr port, int index, int dir,int data)
{
     ...
     case 0x400FF000u:
         ...
         break;
     case 0x400FF040u:
         p = ((PORT_MemMapPtr)0x4004A000u);
         break;
     case 0x400FF080u:
         p = ((PORT_MemMapPtr)0x4004B000u);
         break;
     case 0x400FF0C0u:
         p = ((PORT_MemMapPtr)0x4004C000u);
         break;
     case 0x400FF100u:
         p = ((PORT_MemMapPtr)0x4004D000u);
         break;
     default:
         break;
     }

     ((p)->PCR[index]) |= (0|(((uint32_t)(((uint32_t)(1))<<8))&0x700u));   

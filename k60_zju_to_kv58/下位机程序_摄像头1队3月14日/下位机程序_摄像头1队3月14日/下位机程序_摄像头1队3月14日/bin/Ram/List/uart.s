///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V8.10.1.12857/W32 for ARM      30/Aug/2018  15:16:07
// Copyright 1999-2017 IAR Systems AB.
//
//    Cpu mode     =  thumb
//    Endian       =  little
//    Source file  =  
//        C:\Users\Lenovo\Desktop\class3\@@@@@_@@@1@3@14@\@@@@@_@@@1@3@14@\src\Sources\C\Component_C\uart.c
//    Command line =  
//        -f C:\Users\Lenovo\AppData\Local\Temp\EWD4B9.tmp
//        (C:\Users\Lenovo\Desktop\class3\@@@@@_@@@1@3@14@\@@@@@_@@@1@3@14@\src\Sources\C\Component_C\uart.c
...
//    Locale       =  C
//    List file    =  
//        C:\Users\Lenovo\Desktop\class3\@@@@@_@@@1@3@14@\@@@@@_@@@1@3@14@\bin\Ram\List\uart.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   23 	if (uartch == UART0_BASE_PTR)
        LDR.N    R1,??DataTable0  ;; 0x4006a000
        CMP      R0,R1
        BNE.N    ??uart_init_0
//   24 	{
...
??uart_init_0:
        LDR.N    R1,??DataTable0_3  ;; 0x4006b000
        CMP      R0,R1
        BNE.N    ??uart_init_2
//   30 	{
...
??uart_init_2:
        LDR.N    R1,??DataTable0_6  ;; 0x4006c000
        CMP      R0,R1
        BNE.N    ??uart_init_3
//   37 	{
...
??uart_init_3:
        LDR.N    R1,??DataTable0_9  ;; 0x4006d000
        CMP      R0,R1
        BNE.N    ??uart_init_4
//   43 	{
...
??uart_init_4:
        LDR.N    R1,??DataTable0_12  ;; 0x400ea000
        CMP      R0,R1
        BNE.N    ??uart_init_5
//   49 	{
...
??uart_init_5:
        LDR.N    R1,??DataTable0_15  ;; 0x400eb000
        CMP      R0,R1
        BNE.N    ??uart_init_1
//   55 	{
...
//   64 		SIM_SCGC4 |= SIM_SCGC4_UART0_MASK;
        LDR.N    R1,??DataTable0_18  ;; 0x40048034
        LDR      R1,[R1, #+0]
        ORRS     R1,R1,#0x400
...
//   76 						SIM_SCGC1 |= SIM_SCGC1_UART4_MASK;
        LDR.N    R1,??DataTable0_19  ;; 0x40048028
        LDR      R1,[R1, #+0]
        ORRS     R1,R1,#0x400

...
#define MPU_SDA_IN()  GPIO_Init(GPIOD,9,GPI,1);
#define MPU_SDA_OUT() GPIO_Init(GPIOD,9,GPO,1);

#define MPU_IIC_SCL        PTD8_OUT 		//SCL
#define MPU_IIC_SDA_OUT    PTD9_OUT		//SDA	 
#define MPU_IIC_SDA_IN     PTD9_IN		//SDA
